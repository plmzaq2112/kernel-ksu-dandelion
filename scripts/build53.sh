...
make -C $SRC O=/home/a12bbb/android-kernel/kernel-upgrade/mtk50-port/out_blossom ARCH=arm64 CC=clang \
    ...
    -j$(nproc) Image.gz > /home/a12bbb/android-kernel/kernel-upgrade/mtk50-port/build_ksu53.log 2>&1
echo "RC=$?"
grep -E "^ERROR|^error:|undefined reference|fatal" /home/a12bbb/android-kernel/kernel-upgrade/mtk50-port/build_ksu53.log | grep -v '^$' | sort -u | head -20
echo "--- tail ---"
tail -8 /home/a12bbb/android-kernel/kernel-upgrade/mtk50-port/build_ksu53.log
